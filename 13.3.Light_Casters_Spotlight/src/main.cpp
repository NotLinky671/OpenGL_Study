...
// -------------------------------------------------------------------------------------------------
    // 创建Window(窗口)
    GLFWwindow* window = glfwCreateWindow(1000, 720, "OpenGL_Study_Light_Casters_Spotlight", NULL, NULL);
    if(window == NULL) {
...
// -------------------------------------------------------------------------------------------------
    ...
    glm::vec3 cube_scale(10.0f, 1.0f, 10.0);
    // View
    glm::mat4 view;
    // Projection
    glm::mat4 projection;
...
// -------------------------------------------------------------------------------------------------
        ...
        MyShader->setFloat("light.cutOff", glm::cos(glm::radians(light.cutOff)));
        MyShader->setFloat("light.outerCutOff", glm::cos(glm::radians(light.outerCutOff)));
