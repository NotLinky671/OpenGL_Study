...
// -------------------------------------------------------------------------------------------------
    // 创建Window(窗口)
    GLFWwindow* window = glfwCreateWindow(1000, 720, "OpenGL_Study_Stencil_Testing", NULL, NULL);
    if(window == NULL) {
...
// -------------------------------------------------------------------------------------------------
    // Shader
    Shader* cube_shader = new Shader("shaders/Stencil_Testing.vert", "shaders/Shader_SingleColor.frag");
    Shader* plane_shader = new Shader("shaders/Stencil_Testing.vert", "shaders/Stencil_Testing_Plane.frag");
    Shader* cube_texture_shader = new Shader("shaders/Stencil_Testing.vert", "shaders/Stencil_Testing.frag");
// -------------------------------------------------------------------------------------------------
    // cube_VBO
